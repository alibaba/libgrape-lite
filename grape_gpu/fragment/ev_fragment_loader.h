...
#ifndef GRAPE_GPU_FRAGMENT_EV_FRAGMENT_LOADER_H_
#define GRAPE_GPU_FRAGMENT_EV_FRAGMENT_LOADER_H_
...
class EVFragmentLoader {
 ...
 public:
  explicit EVFragmentLoader(const grape::CommSpec& comm_spec)
...
#endif  // GRAPE_GPU_FRAGMENT_EV_FRAGMENT_LOADER_H_
