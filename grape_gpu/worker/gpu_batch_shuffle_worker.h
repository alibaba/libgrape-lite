#ifndef GRAPE_GPU_WORKER_GPU_BATCH_SHUFFLE_WORKER_H_
#define GRAPE_GPU_WORKER_GPU_BATCH_SHUFFLE_WORKER_H_
#include <utility>
...
#endif  // GRAPE_GPU_WORKER_GPU_BATCH_SHUFFLE_WORKER_H_
