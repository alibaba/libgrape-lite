#ifndef GRAPE_GPU_PARALLEL_BATCH_SHUFFLE_MESSAGE_MANAGER_H_
#define GRAPE_GPU_PARALLEL_BATCH_SHUFFLE_MESSAGE_MANAGER_H_
...
#endif  // GRAPE_GPU_PARALLEL_BATCH_SHUFFLE_MESSAGE_MANAGER_H_
