...
public class LibgrapeJob extends science.atlarge.granula.modeller.platform.operation.AbstractOperationModel {

    public LibgrapeJob() {
        super(Type.libgrape, Type.Job);
    }
