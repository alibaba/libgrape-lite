...
#ifndef EXAMPLES_ANALYTICAL_APPS_PAGERANK_PAGERANK_DIRECTED_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_PAGERANK_PAGERANK_DIRECTED_CONTEXT_H_
...
class PageRankDirectedContext : public VertexDataContext<FRAG_T, double> {
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

 public:
  explicit PageRankDirectedContext(const FRAG_T& fragment)
...
#endif  // EXAMPLES_ANALYTICAL_APPS_PAGERANK_PAGERANK_DIRECTED_CONTEXT_H_
